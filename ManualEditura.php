...
$sql = "SELECT M.Denumire as Manual
FROM Editura Ed join Manual M on Ed.EdituraID = M.Editura_ID
WHERE (M.Clasa = '$Clasa' AND Ed.Denumire = '$Editura');";
echo "<center><h1>Manualele de clasa a $Clasa-a de la editura $Editura</h1></center>";
$result = mysqli_query($conn, $sql);
if (mysqli_num_rows($result) > 0)
	{	
		while($row = mysqli_fetch_assoc($result))
		{
		echo "<div><tr><td>" . $row["Manual"] . "</td></tr></div>";
		}
	}
	else {
		echo "No results";
