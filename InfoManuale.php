...
<br><br><br>
<form action="CelMaiFolositManual.php" method="post">
<button center = "left" type ="submit" width = "50px" height = "2px" name="submit">Vezi manualul cel mai folosit de elevi</button>
<br><br><br>
		</div>
	</body>
</html>