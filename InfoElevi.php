...
echo "<center><h1>Informatii despre elevi</h1></center>";
$sql = "SELECT E.Nume as Nume, E.Prenume as Prenume, E.Clasa as Clasa, S.Denumire as Scoala
		FROM Elev E join Scoala S on E.ScoalaID = S.ScoalaID";
...
if (mysqli_num_rows($result) > 0)
	{	 
		...
		{
		echo "<div><tr><td>" . $row["Nume"] . "</td>   <td>" . $row["Prenume"] . "</td>   <td>" . $row["Clasa"] . "</td> <td>" . $row["Scoala"] . "</td></tr></div>";
		}
	}
	else {
		echo "No results";
