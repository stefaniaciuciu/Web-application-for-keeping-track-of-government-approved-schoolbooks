...
echo "<center><h1>Editurile care nu au publicat niciun manual de $Materie</h1></center>";
$sql = "SELECT Ed.Denumire as Editura
FROM Editura Ed 
WHERE Ed.Denumire not in (SELECT E.Denumire 
                          FROM Editura E join Manual M on E.EdituraID = M.Editura_ID
...
if (mysqli_num_rows($result) > 0)
	{	 
		...
		{
		echo "<div><tr><td>" . $row["Editura"] . "</td></tr></div>";
		}
	}
	else {
		echo "No results";
