...
$sql = "SELECT count(Ex.ElevID) as NrManuale
FROM Manual M join Editura Ed on M.Editura_ID = Ed.EdituraID
			  join Exemplar Ex on M.ManualID = Ex.ManualID
WHERE M.Materie = 'Chimie' AND Ed.Denumire = '$Editura';";
$result = mysqli_query($conn, $sql);
echo "<center><h1>Numarul de manuale de Chimie de la editura $Editura</h1></center>";
