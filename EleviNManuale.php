...
echo "<center><h1>Elevii care nu au niciun manual de $Materie</h1></center>";
$sql = "SELECT E.Nume as Nume, E.Prenume as Prenume
FROM Elev E 
WHERE E.ElevID not in (SELECT Ex.ElevID
                       FROM Exemplar Ex join Manual M on Ex.ManualID = M.ManualID
                       WHERE M.Materie = '$Materie')";
